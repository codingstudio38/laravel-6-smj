                        ...
                        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form id="general-info" class="section general-info" action="{{url('/')}}/add-department-master" method="post">
                                   {!! csrf_field() !!}  
                                        <div class="info">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-5">
                                                                        <div class="form-group">
                                                                            <label for="fullName">Department Number</label>
                                                                            <input type="number" class="form-control mb-4"   value="" name="dept_no" required="">
                                                                        </div>
                                                                    </div>
                                                                      <div class="col-sm-5">
                                                                        <div class="form-group">
                                                                            <label for="fullName">Department Name</label>
                                                                            <input type="text" class="form-control mb-4"   value="" name="dept_name" required="">
                                                                        </div>
                                                                    </div>
                                         ...
                                         @foreach($Department_view as $ky=>$val)
                                           <tr>
                                                ...
                                                <a href=""  data-toggle="modal" data-target="#myModal" title="Edit" class="editbtn" class="btn btn-success editbtn" ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 text-success"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a>
                                                 <a href="delete_Department_data/{{ $val->id }}" data-toggle="tooltip" data-placement="top" title="Delete"  onclick="return confirm('Do you want to delete this department record?');"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2 text-danger"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></a>
                                                 </td> 
                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content animated fadeInUp">
                      <div class="modal-header">
                        <h5 class="modal-title">Edit Deaprtment Details</h5>
                   ...
                   <div class="form-group">
                            ...
                            <div class="form-group">
                              <label for="exampleInputtext1">Department Number</label>
                              <input type="text" class="form-control" id="dept_no" name="dept_no" aria-describedby="textHelp">
                              
                            </div>
                            <div class="form-group">
                              <label for="exampleInputtext1">Department Name</label>
                              <input type="text" class="form-control" id="dept_name" name="dept_name" aria-describedby="textHelp">
       ...
       $(document).ready(function(){
        $('.editbtn').on('click' ,function(){
          ...
          $tr = $(this).closest('tr');
           ...
           console.log(data);
          $('#dept_id').val(data[0]).prop("disabled", true);;
           $('#dept_no').val(data[1]);
