                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-4" id="emp_no"  name="emp_no" value="{{ $EmployeeAllInfo->emp_no }}" readonly="readonly">
                       ...
                       <div class="col-sm-2">
                        ...
                        <div class="col-sm-6 ">
                         ...
                         <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-4" id="emp_name" name="emp_name"  value="{{ $EmployeeAllInfo->emp_name }}" required=""/>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-4" id="emp_code" name="emp_code"   value="{{ $EmployeeAllInfo->employee_code }}" required>
                         ...
                         <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control mb-4" onchange="check()" id="emp_type" name="emp_type" required>
                                    <option value="">select</option>
                          ...
                          <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control mb-4" id="designation" name="designation" required>
                                    <option value="">select</option>
                         ...
                         <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control mb-4" id="workplace" name="workplace" required>
                                    <option value="">select</option>
...
<link href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/themes/base/jquery-ui.css" rel="stylesheet" />
                        <div class="col-sm-4">
                            <div class="form-group">
                              ...
                              <input  id="dtpFrDate" type='text' class="form-control mb-4" name="DOB" value="{{date('d-m-Y', strtotime($EmployeeAllInfo->DOB))}}"required >
                  ...
                  <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input id="dtpFrDate1" type="text" class="form-control mb-4"  name="DOJ"  value="{{date('d-m-Y', strtotime( $EmployeeAllInfo->DOJ)) }}" required>
                           ...
                           <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                @if($EmployeeAllInfo->DOP=="")
                                
                             <input type="text" class="form-control mb-4" name="DOP" id="dtpFrDate2" value="" placeholder="dd-mm-yyyy">
                                
                                @else
                                   <input type="text" class="form-control mb-4" name="DOP" id="dtpFrDate2" value="{{ date('d-m-Y', strtotime($EmployeeAllInfo->DOP)) }}" required>
                               @endif
                            ...
                            <div class="form-group">
                                <label for="fullName">Date of Confirmation<span class="employeemaster" id="doc_div"></span></label>
                                  ...
                                  @if($EmployeeAllInfo->confirm_date=="")
                                  <input type="text" class="form-control mb-4" name="DOC" id="dtpFrDate3" placeholder="dd-mm-yyyy">
                                  @else
                                   <input type="text" class="form-control mb-4" name="DOC" id="dtpFrDate3" value="{{date('d-m-Y', strtotime( $EmployeeAllInfo->confirm_date ))}}">
                                  @endif
                    ...
                    <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="datextte" class="form-control mb-4" name="retirement_date" id=dtpFrDate4 placeholder="dd-mm-yyyy" disabled>
                                @else
                                 @if($EmployeeAllInfo->retirement_date=="")
                                <input type="datextte" class="form-control mb-4" name="retirement_date" id=dtpFrDate4 placeholder="dd-mm-yyyy">
                                  @else
                                <input type="datextte" class="form-control mb-4" name="retirement_date" id=dtpFrDate4 value="{{ date('d-m-Y', strtotime($EmployeeAllInfo->retirement_date)) }}">
                                @endif
                                @endif
...
@if( Auth::user()->role == "Administrator"||Auth::user()->role == "HR Manager"||Auth::user()->role == "Finance Staff") 
            ...
            <h4 class="mb-4">Pay Scale Details</h4>
                        ...
                        <div class="col-sm-2">
                                <div class="form-group">
                                  ...
                                  $ps=array();
                                    ...
                                    <input type="text" class="form-control mb-4"   value="{{@$ps[0]->pay_scale}}" name ="pay_grade" id='catch_value' style="font-size: 13px;color: black;" readonly="readonly">
                        ...
                        <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-4" id="vperc_textbox" value="{{$EmployeeAllInfo->vp_perc}}" name ="vpf" placeholder="Ex: 10.00">
                                </div>
                            </div>
                        <div class="col-sm-2">
                                <div class="form-group">
                                    <label for="fullName">ESI A/C No</label>
                                    <input type="number" class="form-control mb-4" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="10" minlength="10" value="{{$EmployeeAllInfo->esi_ac_no}}"  name ="esi" id="esiacc">
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57"  class="form-control mb-4" id="uano" value="{{$EmployeeAllInfo->UAN}}" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="uan">
                                ...
                                <div class="form-group">
                                  ...
                                  $ps=array();
                                    ...
                                    <label for="fullName">Initial Special Allowance</label>
                                     <input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" id="initial_allowance" class="form-control mb-4"   name ="intial" readonly="readonly" value="{{@$ps1[0]->special_allowance}}"  readonly="readonly" style="font-size: 13px;color: black;">
                              ...
                              <div class="col-sm-4">
                                <div class="form-group">
                                  ...
                                  $ps=array();
                                    ...
                                    <input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control mb-4"   value="{{@$ps1[0]->special_allowance}}" name="current" id="current_allowance"  readonly="readonly" style="font-size: 13px;color: black;" >
                              ...
                              <div class="col-sm-4">
                                <div class="form-group">
                                  ...
                                  $ps=array();
                                    ...
                                    <input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control mb-4"   value="{{@$ps2[0]->other_special_allowance}}" name ="initial_other" id="initial_other"  readonly="readonly" style="font-size: 13px;color: black;">
                              ...
                              <div class="col-sm-4">
                                <div class="form-group">
                                  ...
                                  $ps=array();
                                    ...
                                    <input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control mb-4"   value="{{@$ps2[0]->other_special_allowance}}" name="current_other" id="cuurent_other"  readonly="readonly" style="font-size: 13px;color: black;">
                             ...
                             <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control mb-4"   value="{{@$EmployeeAllInfo->intial_basic}}" name="intial_basic" id="intial_basic" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control mb-4"    value="{{@$EmployeeAllInfo->current_basic}}" name="current_basic" id="current_basic">
                    ...
                    <h5 class="card-user_name">Bank Details</h5>
                        <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mb-4"   value="{{@$EmployeeAllInfo->payment_mode}}" name="payment_bank_mode" id="current_basic">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <!--  <input type="text" class="form-control mb-4"   value="{{@$EmployeeAllInfo->bank_code}}" name="bank_name" id="current_basic"> -->

                                      <select class="form-control mb-4" id="exampleFormControlSelect1" name="bank_name" required>
                                    <option>Select</option>
                               ...
                               <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <lable for="fullName" id="bank"></lable>
                                    <input type="text" class="form-control mb-4"   value="{{@$EmployeeAllInfo->bank_ac_no}}" \
            ...
            <div class="card-body">
                ...
                <div class="user-info">
                    <h5 class="card-user_name">Increment Details</h5>
                                   ...
                                   <lable for="fullName" id="bank"> </lable>
                                    <input type="date" class="form-control mb-4"   value="{{@$EmployeeAllInfo->incr_due_date}}" name="incr_date" id="current_basic">
                                 </div>
                                   ...
                                   <div class="col-sm-12">
                                    ...
                                    <label for="fullName">Increment Amount: </label>
                                       <lable for="fullName" id="bank"></lable>
                                       <input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control mb-4"   value="{{@$EmployeeAllInfo->incr_amt}}" name="incr_amount" id="current_basic">
                                    </select>
 ...
 <div class="col-sm-3">
    <div class="form-group">
        ...
        <input type="text" class="form-control mb-4"  placeholder="per_line1" name="per_line1" value="{{$EmployeeAllInfo->PERM_ADDRESS1}}">
        <input type="text" class="form-control mb-4" placeholder="per_line2" name="per_line2"  value="{{$EmployeeAllInfo->PERM_ADDRESS2}}">
        <input type="text" class="form-control mb-4" placeholder="per_line3" name="per_line3"  value="{{$EmployeeAllInfo->PERM_ADDRESS3}}">
...
@endphp
<tr>
<td><input type="number" value="{{$value->slno}}" class="form-control td2" name="depend_snno[]" id="depend_snno{{$i}}"  ></td>
<td class="td2">
...
@if($ctr==0)
    <tr>
      <td><input type="number" class="form-control td2" name="depend_snno[]" id="depend_snno{{$i}}"  ></td>
...
<td>
  <input type="number" value="{{$value->slno}}" class="form-control td2" name="academic_snno[]" id="academic_snno{{$value->id}}"  >
</td> 
...
@if($ctr_qual==0)
  ...
  <tr>
    <td>
      <input type="number" class="form-control td1" name="academic_snno[]"  >
    </td>  
...
@endif
 ...
 <div class="col-lg-12 emp-sec">
      <div class="row">
        <div class="col-sm-12">
           <h4 class="mb-4">Technical/Professional</h4>
        </div>
        <div class="col-lg-12" style="overflow-y: auto;
height: 400px;position: relative;">
...
<tr>
  <td>
    <input type="number" class="form-control td2" name="experience_snno[]"  value="{{$value->slno}}" >
  </td>
<td>
...
@if($ctr_exper==0)
    <tr>
      <td>
        <input type="number" class="form-control td1" name="experience_snno[]"  >
      </td>   
  <td>  
...
<tr>
  <td>
    <input type="number" class="form-control td2" name="transfer_snno[]"  value="{{$value->slno}}" >
  </td>
<td>
...
@if($ctr_trans==0)
    <tr>
      <td>
        <input type="number" class="form-control td1" name="transfer_snno[]"  >
      </td>    
  <td>  
...
<tr>
  <td>
    <input type="number" class="form-control td2" name="promo_slno[]" value="{{$value->slno}}" >
  </td>
...
<td>
  ...
  <input type="text" class="form-control width3" name="from_basic[]" value="{{$value->from_basic_pay}}" id='catch_paygrade_value{{$i}}' style="    width: 202px;color: black" readonly="readonly"></td>
<td><input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control width" name="from_special[]" id="promtion_current_allowance{{$i}}" value="{{$value->special_allownace}}"readonly="readonly"  style="    width: 202px;color: black"></td>
<td><input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control width" name="from_other_special[]"  id="promtion_currentother_allowance{{$i}}" value="{{$value->other_special_allownace}}" readonly="readonly" style="    width: 202px;color: black"></td>
...
<td><input type="text" class="form-control width" name="to_basic[]" value="{{$value->to_basic_pay}}" style="width: 202px; color: black" id='catch_topaygrade_value{{$i}}'readonly="readonly"></td>
<td><input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control width" name="total_allow[]" value="{{$value->total_allowance}}" id="promtion_tocurrent_allowance{{$i}}"readonly="readonly" style="width: 202px; color: black"></td>
<td><input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control width" name="to_other_allowance[]" value="{{$value->other_allowance}}" id="promtion_tocurrentother_allowance{{$i}}"readonly="readonly" style="width: 202px; color: black"></td>
...
@if($ctr_promo==0)
    <tr>
      <td>
        <input type="number" class="form-control td1" name="promo_slno[]" >
      </td>
...
<td><input type="text" class="form-control width" name="from_basic[]" id='catch_paygrade_value{{$i}}' style="    width: 202px;color: black" readonly="readonly"></td>
<td><input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control width3" name="from_special[]" id="promtion_current_allowance{{$i}}" readonly="readonly"  style="    width: 202px;color: black"></td>
<td><input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control width3" name="from_other_special[]"  id="promtion_currentother_allowance{{$i}}" readonly="readonly"  style="    width: 202px;color: black"></td>
...
<td><input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control width3" name="total_allow[]" id="promtion_tocurrent_allowance{{$i}}" readonly="readonly" ></td>
<td><input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control width3" name="to_other_allowance[]" id="promtion_tocurrentother_allowance{{$i}}" readonly="readonly"></td>
...
<tr>
  <td>
    <input type="number" class="form-control td2" value="{{$value->slno}}" name="prob_slno[]"  >
  </td> 
  <td>
...
<td><input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control width2" name="special_allowance[]"value="{{$value->special_allowance}}" id="probation_current_allowance{{$i}}" readonly="readonly"></td>
<td><input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control width2" name="other_allownace[]"value="{{$value->other_allowance}}" id="probation_tocurrentother_allowance{{$i}}" readonly="readonly" ></td>
...
@if($ctrprob==0)
    <tr>
      <td>
        <input type="number" class="form-control td1" name="prob_slno[]"  >
      </td>    
<td>    
...
<td><input type="date" class="form-control"  placeholder="13/07/2008" name="prob_end[]"></td>
<td>
...
<td><input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control width2" name="special_allowance[]"id="probation_current_allowance{{$i}}" readonly="readonly"></td>
<td><input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control width2" name="other_allownace[]"id="probation_tocurrentother_allowance{{$i}}" readonly="readonly" ></td>
...
@endphp  
<td>
  <input type="number" class="form-control td2" name="cont_slno[]" value="{{$value->slno}}" >
</td>  
<td>
...
<tr>
  <td>
    <input type="number" class="form-control td1" name="cont_slno[]"  >
  </td>
<td>
...
<td>
  <input type="number" class="form-control td2" name="antecedent_slno[]" value="{{$value->slno}}" >
</td>
<td>
...
<tr>
  <td>
    <input type="number" class="form-control td1" name="antecedent_slno[]"  >
  </td>  
  <td>
...
@endphp 
<td>
  <input type="number" class="form-control td2" name="revo_slno[]" value="{{$value->slno}}" >
</td>
<td>
...
<tr>
  <td>
    <input type="number" class="form-control td1" name="revo_slno[]"  >
  </td>
<td>
...
@endphp 
<td>
  <input type="number" class="form-control td2" name="app_slno[]" value="{{$value->slno}}" >
</td>
<td>
...
<tr id="R">
  <td>
    <input type="number" class="form-control td1" name="app_slno[]" >
  </td>
 <td> 
...
@endphp 
<td>
  <input type="number" class="form-control td2" name="reward_slno[]" value="{{$value->slno}}" >
</td>
<td>
...
<tr>
  <td>
    <input type="number" class="form-control td1" name="reward_slno[]" >
  </td>
<td>
...
@endphp 
<td>
  <input type="number" class="form-control td2" name="intiation_slno[]" value="{{$value->slno}}" >
</td>
<td>
...
<tr>
  <td>
    <input type="number" class="form-control td1" name="intiation_slno[]"  >
  </td>
<td>
...
@endphp 
<td>
  <input type="number" class="form-control td2" name="achievement_slno[]"  value="{{$value->slno}}" >
</td>
<td>
...
<tr>
  <td>
    <input type="number" class="form-control td1" name="achievement_slno[]"  >
  </td>
<td>
...
<tr id="remark_tr_{{ $val->id }}">
  <td align="center">
    <input type="number" class="form-control td2" name="remark_slno[]" id="remark_slno_{{ $val->id }}" value="{{ $val->slno }}" style="margin: auto;"  >
  </td>
  <td align="center">
 ...
 @else 
  ...
  <tr id="remark_tr_{{ $v }}">
    <td align="center">
      <input type="number" class="form-control td1" name="remark_slno[]" id="remark_slno_{{ $v }}"   style="margin: auto;">
    </td>
  <td align="center">
...
$("#remark_body").append(`<tr id="remark_tr_${num}">
  <td align="center">
      <input type="number" class="form-control td1" name="remark_slno[]" id="remark_slno_${num}"   style="margin: auto;">
    </td>
  <td align="center">
...
<div class="modal fade" id="exampleModal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center" style="height: 500px; overflow: scroll; display: flex;
      align-items: center;
...
$("#addBtn1").click(function () { 
  l++;
  $("#e-body").append(`<tr>
    <td><input type="number" class="form-control td2" name="depend_snno[]" id="depend_snno${l}"  ></td>     
     ...
     $(document).ready(function () {
      ...
      $('#addBtnQual').on('click', function () {
        ...
        $('#e-body_qual').append(`<tr id="R${++rowIdx}">
                 <p>Row ${rowIdx}</p>
<td>
  <input type="number" value="" class="form-control td2" name="academic_snno[]" id="academic_snno${rowIdx}" >
</td>
 <td>
  ...
  <td><button type="button" class="deletebtn" title="Remove row" style="background-color: #7d98da">X</button></td>
      ...
      $('#addBtn2').on('click', function () {
        ...
        $('#experience_body').append(`<tr id="R${++rowIdx}">
                 <p>Row ${rowIdx}</p>
                 <td>
  <input type="number" class="form-control td2" name="experience_snno[]"  >
</td>                 
 ...
 <td><button type="button" class="deletebtn" title="Remove row" style="background-color: #7d98da">X</button></td>
  ...
  $('#add_new_appreciation').on('click', function () {
    ...
    $('#table_appreciation').append(`<tr id="R${++rowIdx}">
             <p>Row ${rowIdx}</p>
<td>
  <input type="number" class="form-control td2" name="app_slno[]" >
</td>
             <td>
              <input type="hidden" class="form-control" name="appr_sqli_id[]">
             <input type="text" class="form-control width" name="app_order_no[]"></td>
...
var j=20;
    ...
    $("#table_transfer").append(`<tr>
      <td>
    <input type="number" class="form-control td2" name="transfer_snno[]"  >
  </td>
       <td>
         <input type="hidden" class="form-control" name="transfer_sql_id[]">
   <input type="text" class="form-control width" width="130px" name="trans_order[]"></td>
...
style="background-color: #7d98da">X</button></td>
  ...
  $('#add_new_reward').on('click', function () {
    ...
    $('#table_reward').append(`<tr id="R${++rowIdx}">
             <p>Row ${rowIdx}</p>
             <td>
    <input type="number" class="form-control td2" name="reward_slno[]" >
  </td>
<td>
  <input type="hidden" class="form-control" name="reward_sqli_id[]">
<input type="text" class="form-control width" name="reorder_no[]"></td>
...
//alert(k);
  $("#promo_tbl").append(`<tr>
    <td>
    <input type="number" class="form-control td2" name="promo_slno[]" >
  </td>
<td>
  <input type="hidden" class="form-control" name="promotion_sql_id[]">
<input type="text" class="form-control width" name="promo_order_no[]"></td>
...
<td><input type="text" class="form-control width" name="from_basic[]" id='catch_paygrade_value${k}' style="    width: 202px; color: black" readonly></td>
<td><input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control width" name="from_special[]" id="promtion_current_allowance${k}" readonly style="    width: 202px; color: black" ></td>
<td><input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control width" name="from_other_special[]"  id="promtion_currentother_allowance${k}" readonly style="    width: 202px; color: black" ></td>
...
<td><input type="text" class="form-control width" name="to_basic[]" id='catch_topaygrade_value${k}'readonly style="    width: 202px; color: black" ></td>
<td><input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control width" name="total_allow[]" id="promtion_tocurrent_allowance${k}" readonly style="    width: 202px; color: black" ></td>
<td><input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control width" name="to_other_allowance[]" id="promtion_tocurrentother_allowance${k}"readonly style="    width: 202px; color: black" ></td>
<td><textarea rows="3" cols="40" class="form-control width" maxlength="150" name="remark[]"></textarea></td>
...
$("#add_newprobation").click(function () { 
  ...
  $("#probationtable").append(`<tr>
    <td>
        <input type="number" class="form-control td2" name="prob_slno[]"  >
      </td>    
<td>
  <input type="hidden" name="prob_sqli_id[]">
<input type="text" class="form-control width" name="prob_order[]"></td>
...
<td>
  <input type="number" class="form-control td2" name="revo_slno[]" >
</td>
<td>
  <input type="hidden" class="form-control" name="revocation_sql_id[]">
...
<p>Row ${rowIdx}</p>
<td>
  <input type="number" class="form-control td2" name="cont_slno[]"  >
</td> 
<td>
...
$(document).ready(function () {
      ...
      $('#add_new7').on('click', function () {
        ...
        $('#tableintiation').append(`<tr id="R${++rowIdx}">
                 ...
                 <td>
    <input type="number" class="form-control td2" name="intiation_slno[]"  >
  </td>                 
    ...
    $(document).ready(function () {
      ...
      $('#add_new8').on('click', function () {
        ...
        $('#tableachievemnt').append(`<tr id="R${++rowIdx}">
                 <p>Row ${rowIdx}</p>
                 <td>
        <input type="number" class="form-control td2" name="achievement_slno[]"  >
      </td>                 
