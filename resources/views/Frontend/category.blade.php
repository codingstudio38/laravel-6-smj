                        ...
                        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form id="general-info" class="section general-info" action="{{url('/')}}/add-category" method="post">
                                   {!! csrf_field() !!}  
                                        <div class="info">
                                ...
                                <div class="row">
                                   <div class="col-sm-2">
                                        <div class="form-group">
                                            <label for="fullName">Category Code</label>
                                            <input type="text" class="form-control mb-4"   value="" name="cat_code" required="">
                                        </div>
                                    </div>
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            <label for="fullName">Category Name</label>
                                            <input type="text" class="form-control mb-4"   value="" name="cat_name" required="">
                                        </div>
                                    </div>
                                          ...
                                          @foreach($Category_view as $ky=>$val)
                                           <tr>
                                                ...
                                                <td>{{$val->category_name}}</td> 
                                                 <td><a href="edit/{{ $val->id }}"  data-toggle="modal" data-target="#myModal" title="Edit" class="editbtn" class="btn btn-success editbtn" ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 text-success"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a> <a href="delete_Category_data/{{ $val->id }}" data-toggle="tooltip" data-placement="top" title="Delete" onclick="return confirm('Do you want to delete this category record?');"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2 text-danger"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></a></td>
              ...
              <div class="modal fade" id="modal-animation-14">
                  <div class="modal-dialog modal-dialog-centered">
                   ...
                   <div class="form-group">
                              ...
                              <input type="hidden" class="form-control" name="cat_id" id="cat_id" aria-describedby="textHelp">
                              
                            </div>

                                        <div class="form-group">
                                            <label for="fullName">Category Code</label>
                                            <input type="text" class="form-control mb-4"   value="" name="cat_code" id="cat_code" required="">
                          </div>
                            <div class="form-group">
                              <label for="exampleInputtext1">Category Name</label>
                              <input type="text" class="form-control" id="cat_name" name="cat_name" aria-describedby="textHelp">
