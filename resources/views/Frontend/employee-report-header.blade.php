...
<head>
    ...
    <link href="{{url('/')}}/public/assets/css/tables/table-basic.css" rel="stylesheet" type="text/css" />
    ...
    <!-- END PAGE LEVEL CUSTOM STYLES -->
     ...
     <script type="text/javascript" src="{{url('/')}}/public/assets/js/xlsx.full.min.js"></script>
     <style> 
        ::-moz-selection {
       /* Code for Firefox */
